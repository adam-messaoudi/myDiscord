...
root.geometry("800x600")  # Définition de la taille de la fenêtre principale

# Changer le fond en noir pour la fenêtre principale
root.configure(bg="black")

# Interface pour visualiser les messages
cadre_messages = tk.Frame(root, bg="black")
cadre_messages.pack(side="left", padx=10, pady=10)

# Interface de connexion
cadre_connexion = tk.Frame(cadre_messages, bg="black")
cadre_connexion.grid(row=2, columnspan=2, pady=10)

etiquette_nom_utilisateur = tk.Label(cadre_connexion, text="Nom d'utilisateur ", bg="black", fg="white")
...
etiquette_mot_de_passe = tk.Label(cadre_connexion, text="Mot de passe ", bg="black", fg="white")
...
bouton_connexion = tk.Button(cadre_connexion, text="Se connecter", command=afficher_message, bg="black", fg="white")
bouton_connexion.grid(row=2, column=0, columnspan=2, pady=5)

# Bouton pour afficher la fenêtre d'inscription
bouton_inscription = tk.Button(cadre_connexion, text="S'inscrire", command=afficher_fenetre_inscription, bg="black", fg="white")
